---
layout:     post
title:      "Offshoring US pharmaceutical manufacturing capacity"
date:       2022-02-19 12:00:00
author:     "Matt Christian"
header-img: "img/cover.jpeg"
---
For decades foreign countries have provided the majority of new Active Pharmaceutical Ingrideint (API) manufacturing capacity for US markets. But the *location* of new overseas API manufacturing sites has evolved over time. And while US dependence on China has been steadily growing, it is actually India with the largest growing in new API capacity.
...
The Medicine Supply Map team applied Natural Language Processing (NLP) and geocoding algorthims to connect DMF holders to specific manufacturing facilities. The model accurately uncovers facility information for more than 80% of active, type II, API DMFs.
